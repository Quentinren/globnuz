...
const NewsCard = () => {
  ...
  // Sample news events data with improved image placeholders
  const newsEvents = [
    {
      ...
      image: "/api/placeholder/400/250?text=Climate+Summit&bgcolor=87CEEB&textcolor=000000",
    ...
    },
    {
      ...
      image: "/api/placeholder/400/250?text=Marine+Sanctuary&bgcolor=0077BE&textcolor=FFFFFF",
    ...
    },
    {
      ...
      image: "/api/placeholder/400/250?text=AI+Conference&bgcolor=232323&textcolor=00FF41",
    ...
    },
    {
      ...
      image: "/api/placeholder/400/250?text=Egyptian+Archaeology&bgcolor=D4B483&textcolor=000000",
    ...
    },
    {
      ...
      image: "/api/placeholder/400/250?text=Rainforest+Conservation&bgcolor=228B22&textcolor=FFFFFF",
  ...
  return (
    <div className="news-card-container">
      <div className={`news-card news-card-theme-${currentIndex % 5}`}>
        ...
        {/* Card Image - FIX: Using image property instead of externalLink */}
